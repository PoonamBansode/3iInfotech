namespace Microsoft.Cognitive.LUIS.ActionBinding
{
    ...
    [Serializable]
    public abstract class BaseLuisAction : ILuisAction // class - BaseLuisAction extend ILuisAction Interface
    {
        public abstract Task<object> FulfillAsync(); // FulfillAsync() method
